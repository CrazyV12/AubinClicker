...
export const BUILDINGS = [
    ...
    { id: 'burger', name: 'Burger Double', icon: '🍔', desc: 'Double steak, double cheese, double Aubin', baseCost: 500, baseCps: 15, count: 0, minRebirth: 0, baseMax: 100, costScale: 1.16 },
    { id: 'kebab', name: 'Kebab Ketchup', icon: '🥙', desc: 'Kebab au ketchup', baseCost: 2000, baseCps: 50, count: 0, minRebirth: 1, baseMax: 80, costScale: 1.17 },
    { id: 'poulet', name: 'Bucket de Poulet', icon: '🍗', desc: 'Le seau familial... pour Aubin tout seul', baseCost: 8000, baseCps: 150, count: 0, minRebirth: 1, baseMax: 70, costScale: 1.18 },
    { id: 'pizza', name: 'Pizza 4 Fromages', icon: '🍕', desc: 'Aubin pourrait en manger 3 d\'affilée', baseCost: 35000, baseCps: 500, count: 0, minRebirth: 2, baseMax: 60, costScale: 1.19 },
    { id: 'buffet', name: 'Buffet à Volonté', icon: '🍖', desc: 'Le patron le reconnaît et pleure quand il arrive', baseCost: 200000, baseCps: 2000, count: 0, minRebirth: 3, baseMax: 50, costScale: 1.20 },
    { id: 'usine', name: 'Usine à Tacos', icon: '🏭', desc: 'Production industrielle pour les besoins d\'Aubin', baseCost: 1500000, baseCps: 8000, count: 0, minRebirth: 5, baseMax: 40, costScale: 1.22 },
...
export const ASCENSION_UPGRADES = [
    ...
    { id: 'unlock_labo', name: 'Savoir Scientifique', icon: '🧪', desc: 'Débloque le Labo de Calories', type: 'unlock', value: 1, baseCost: 15, costMult: 1, maxLevel: 1, minAscension: 1 },
    { id: 'unlock_portail', name: 'Maître Dimensionnel', icon: '🌀', desc: 'Débloque le Portail Gastronomique', type: 'unlock', value: 1, baseCost: 40, costMult: 1, maxLevel: 1, minAscension: 2 },
